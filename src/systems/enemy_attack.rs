...
pub fn enemy_attack(
    ...
    mut enemy_query: Query<
        ...
        // telegraph-scale systems (enemy_special) -- the generic melee here also
        // driving their Transform.scale caused flicker + a double attack. Archers
        // are excluded too: they're ranged kiters and shouldn't also melee.
        (
            With<Enemy>,
            Without<Player>,
            Without<ChargeState>,
